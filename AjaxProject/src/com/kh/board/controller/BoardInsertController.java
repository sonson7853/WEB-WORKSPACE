...
//		String title = request.getParameter("title"); // null
		...
		/*
		 * 폼 전송 시 일반 방식이 아니라 multipart/form-data로 전송하는 경우
	...
	//		System.out.println(category + title);
		...
		// enctype 이 multipart/form-data로 전송되어쓴ㄴ지 확인
...
//			System.out.println(savePath);
			...
			Attachment at = null; // 처음에는 null값으로 초기화 시키고 , 실제로 사용자가 첨부파일을 업로드 했을때만 객체 생성
