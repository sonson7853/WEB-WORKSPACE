		 		...
		 		<script>
		 			$(function(){
		 				...
		 				$("input[name='interest']").each(function(){
		 					//순차적으로 접근한 input요소의 value값을 가져와서 interest변수안에 value값이 포함되어있는지 확인
		 					//포함되어있다면 현재 접근한 input요소의 checked속성을 부여.
		 					if(interest.search($(this).val()) >= 0){ // interest문자열로부터 현재 체크박스의 value가 포함되어있는지확인
